...
export async function getCinema(type,page) {
    const res = await fetch(`https://api.themoviedb.org/3/discover/${type}?page=${page}&api_key=0edad4f6ba800be6e80aeedd54cafc01`)
    if (!res.ok) {
        throw {
            message: "Failed to fetch results",
            statusText: res.statusText,
